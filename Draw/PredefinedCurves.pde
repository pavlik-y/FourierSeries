...
static ArrayList<HarmonicParams> Square = new ArrayList<HarmonicParams>();
...
static {
  ...
  Circle.add(new HarmonicParams(1, 150, -2));
  ...
  MajorChord.add(new HarmonicParams(1, 0, 0));
  MajorChord.add(new HarmonicParams(-1, 0, 0));
  MajorChord.add(new HarmonicParams(2, 0, 0));
  MajorChord.add(new HarmonicParams(-2, 0, 0));
  MajorChord.add(new HarmonicParams(3, 0, 0));
  MajorChord.add(new HarmonicParams(-3, 0, 0));
  MajorChord.add(new HarmonicParams(4, 100, 0));
  MajorChord.add(new HarmonicParams(-4, 0, 0));
  MajorChord.add(new HarmonicParams(5, 100, 0));
  MajorChord.add(new HarmonicParams(-5, 0, 0));
  MajorChord.add(new HarmonicParams(6, 100, 0));
  MajorChord.add(new HarmonicParams(-6, 0, 0));
  for (int i = 7; i < 200; i++) {
  ...
  Mickey.add(new HarmonicParams(0, 30, -1.570797));
  ...
  Square.add(new HarmonicParams(0, 0, 0));
  Square.add(new HarmonicParams(1, 171.948143, -2.356194));
  Square.add(new HarmonicParams(-1, 0.000000, 1.200075));
  Square.add(new HarmonicParams(2, 0.000000, -2.988743));
  Square.add(new HarmonicParams(-2, 0.000000, -2.279678));
  Square.add(new HarmonicParams(3, 0.000000, -2.857748));
  Square.add(new HarmonicParams(-3, 19.105698, -2.356194));
  Square.add(new HarmonicParams(4, 0.000000, -0.207885));
  Square.add(new HarmonicParams(-4, 0.000000, -1.770065));
  Square.add(new HarmonicParams(5, 6.878303, -2.356194));
  Square.add(new HarmonicParams(-5, 0.000000, 0.745095));
  Square.add(new HarmonicParams(6, 0.000000, 1.163721));
  Square.add(new HarmonicParams(-6, 0.000000, -1.072538));
  Square.add(new HarmonicParams(7, 0.000000, -0.063388));
  Square.add(new HarmonicParams(-7, 3.509531, -2.356194));
  Square.add(new HarmonicParams(8, 0.000000, 0.906638));
  Square.add(new HarmonicParams(-8, 0.000000, -0.861054));
  Square.add(new HarmonicParams(9, 2.123205, -2.356194));
  Square.add(new HarmonicParams(-9, 0.000000, 2.320535));
  Square.add(new HarmonicParams(10, 0.000000, -0.543526));
  Square.add(new HarmonicParams(-10, 0.000000, 0.695686));
  Square.add(new HarmonicParams(11, 0.000000, -0.877286));
  Square.add(new HarmonicParams(-11, 1.421449, -2.356194));
  Square.add(new HarmonicParams(12, 0.000000, 2.303615));
  Square.add(new HarmonicParams(-12, 0.000000, 0.061953));
  Square.add(new HarmonicParams(13, 1.017835, -2.356194));
  Square.add(new HarmonicParams(-13, 0.000000, 2.137137));
  Square.add(new HarmonicParams(14, 0.000000, 1.418510));
  Square.add(new HarmonicParams(-14, 0.000000, -1.014478));
  Square.add(new HarmonicParams(15, 0.000000, -2.882815));
  Square.add(new HarmonicParams(-15, 0.764605, -2.356194));
  Square.add(new HarmonicParams(16, 0.000000, -1.590463));
  Square.add(new HarmonicParams(-16, 0.000000, 0.874871));
  Square.add(new HarmonicParams(17, 0.595368, -2.356194));
  Square.add(new HarmonicParams(-17, 0.000000, -0.643794));
  Square.add(new HarmonicParams(18, 0.000000, 2.332746));
  Square.add(new HarmonicParams(-18, 0.000000, -2.349349));
  Square.add(new HarmonicParams(19, 0.000000, -1.863124));
  Square.add(new HarmonicParams(-19, 0.476703, -2.356194));
  Square.add(new HarmonicParams(20, 0.000000, 0.973655));
  Square.add(new HarmonicParams(-20, 0.000000, -1.126135));
  Square.add(new HarmonicParams(21, 0.390297, -2.356194));
  Square.add(new HarmonicParams(-21, 0.000000, 1.843098));
  Square.add(new HarmonicParams(22, 0.000000, 0.239549));
  Square.add(new HarmonicParams(-22, 0.000000, -1.474920));
  Square.add(new HarmonicParams(23, 0.000000, 2.324053));
  Square.add(new HarmonicParams(-23, 0.325436, -2.356194));
  Square.add(new HarmonicParams(24, 0.000000, -2.762465));
  Square.add(new HarmonicParams(-24, 0.000000, -0.870350));
  Square.add(new HarmonicParams(25, 0.275510, -2.356194));
  Square.add(new HarmonicParams(-25, 0.000000, -1.467413));
  Square.add(new HarmonicParams(26, 0.000000, 0.096692));
  Square.add(new HarmonicParams(-26, 0.000000, -1.247515));
  Square.add(new HarmonicParams(27, 0.000000, -2.498846));
  Square.add(new HarmonicParams(-27, 0.236261, -2.356194));
  Square.add(new HarmonicParams(28, 0.000000, -1.144753));
  Square.add(new HarmonicParams(-28, 0.000000, 2.395731));
  Square.add(new HarmonicParams(29, 0.204850, -2.356194));
  Square.add(new HarmonicParams(-29, 0.000000, -1.322297));
  Square.add(new HarmonicParams(30, 0.000000, 2.213801));
  Square.add(new HarmonicParams(-30, 0.000000, 2.127360));
  Square.add(new HarmonicParams(31, 0.000000, -1.539553));
  Square.add(new HarmonicParams(-31, 0.179319, -2.356194));
  Square.add(new HarmonicParams(32, 0.000000, -1.541674));
  Square.add(new HarmonicParams(-32, 0.000000, 0.644776));
  Square.add(new HarmonicParams(33, 0.158289, -2.356194));
  Square.add(new HarmonicParams(-33, 0.000000, -0.121356));
  Square.add(new HarmonicParams(34, 0.000000, 1.535408));
  Square.add(new HarmonicParams(-34, 0.000000, -2.538808));
  Square.add(new HarmonicParams(35, 0.000000, -1.461001));
  Square.add(new HarmonicParams(-35, 0.140759, -2.356194));
  Square.add(new HarmonicParams(36, 0.000000, 0.318312));
  Square.add(new HarmonicParams(-36, 0.000000, -1.894631));
  Square.add(new HarmonicParams(37, 0.125995, -2.356194));
  Square.add(new HarmonicParams(-37, 0.000000, -3.045419));
  Square.add(new HarmonicParams(38, 0.000000, -1.729323));
  Square.add(new HarmonicParams(-38, 0.000000, 1.056958));
  Square.add(new HarmonicParams(39, 0.000000, 0.790644));
  Square.add(new HarmonicParams(-39, 0.113443, -2.356194));
  Square.add(new HarmonicParams(40, 0.000000, 1.698055));
  Square.add(new HarmonicParams(-40, 0.000000, -2.550703));
  Square.add(new HarmonicParams(41, 0.102683, -2.356194));
  Square.add(new HarmonicParams(-41, 0.000000, 0.684125));
  Square.add(new HarmonicParams(42, 0.000000, 2.034629));
  Square.add(new HarmonicParams(-42, 0.000000, -0.278392));
  Square.add(new HarmonicParams(43, 0.000000, 2.943426));
  Square.add(new HarmonicParams(-43, 0.093389, -2.356194));
  Square.add(new HarmonicParams(44, 0.000000, -2.579571));
  Square.add(new HarmonicParams(-44, 0.000000, -2.853306));
  Square.add(new HarmonicParams(45, 0.085306, -2.356194));
  Square.add(new HarmonicParams(-45, 0.000000, 0.922453));
  Square.add(new HarmonicParams(46, 0.000000, 0.590857));
  Square.add(new HarmonicParams(-46, 0.000000, -0.137735));
  Square.add(new HarmonicParams(47, 0.000000, -1.563347));
  Square.add(new HarmonicParams(-47, 0.078234, -2.356194));
  Square.add(new HarmonicParams(48, 0.000000, 0.778081));
  Square.add(new HarmonicParams(-48, 0.000000, -2.810954));
  Square.add(new HarmonicParams(49, 0.072009, -2.356194));
  Square.add(new HarmonicParams(-49, 0.000000, 1.578622));
  Square.add(new HarmonicParams(50, 0.000000, 0.704230));
  Square.add(new HarmonicParams(-50, 0.000000, 2.467095));
  Square.add(new HarmonicParams(51, 0.000000, 1.570949));
  Square.add(new HarmonicParams(-51, 0.066503, -2.356194));
  Square.add(new HarmonicParams(52, 0.000000, -1.319320));
  Square.add(new HarmonicParams(-52, 0.000000, 1.681557));
  Square.add(new HarmonicParams(53, 0.061608, -2.356194));
  Square.add(new HarmonicParams(-53, 0.000000, 1.298806));
  Square.add(new HarmonicParams(54, 0.000000, -2.979203));
  Square.add(new HarmonicParams(-54, 0.000000, -2.829746));
  Square.add(new HarmonicParams(55, 0.000000, 1.816187));
  Square.add(new HarmonicParams(-55, 0.057237, -2.356194));
  Square.add(new HarmonicParams(56, 0.000000, -2.010185));
  Square.add(new HarmonicParams(-56, 0.000000, 0.723072));
  Square.add(new HarmonicParams(57, 0.053318, -2.356194));
  Square.add(new HarmonicParams(-57, 0.000000, -2.425901));
  Square.add(new HarmonicParams(58, 0.000000, -1.957726));
  Square.add(new HarmonicParams(-58, 0.000000, 1.484714));
  Square.add(new HarmonicParams(59, 0.000000, 0.238939));
  Square.add(new HarmonicParams(-59, 0.049791, -2.356194));
  Square.add(new HarmonicParams(60, 0.000000, -1.649925));
  Square.add(new HarmonicParams(-60, 0.000000, -1.976317));
  Square.add(new HarmonicParams(61, 0.046605, -2.356194));
  Square.add(new HarmonicParams(-61, 0.000000, 1.496152));
  Square.add(new HarmonicParams(62, 0.000000, -0.102448));
  Square.add(new HarmonicParams(-62, 0.000000, 1.145523));
  Square.add(new HarmonicParams(63, 0.000000, 1.764327));
  Square.add(new HarmonicParams(-63, 0.043718, -2.356194));
  Square.add(new HarmonicParams(64, 0.000000, 2.065139));
  Square.add(new HarmonicParams(-64, 0.000000, 3.072585));
  Square.add(new HarmonicParams(65, 0.041093, -2.356194));
  Square.add(new HarmonicParams(-65, 0.000000, -2.857690));
  Square.add(new HarmonicParams(66, 0.000000, -2.858066));
  Square.add(new HarmonicParams(-66, 0.000000, -0.416154));
  Square.add(new HarmonicParams(67, 0.000000, 2.455970));
  Square.add(new HarmonicParams(-67, 0.038700, -2.356194));
  Square.add(new HarmonicParams(68, 0.000000, -3.001177));
  Square.add(new HarmonicParams(-68, 0.000000, -1.809671));
  Square.add(new HarmonicParams(69, 0.036511, -2.356194));
  Square.add(new HarmonicParams(-69, 0.000000, 2.066799));
  Square.add(new HarmonicParams(70, 0.000000, -1.061159));
  Square.add(new HarmonicParams(-70, 0.000000, -0.643017));
  Square.add(new HarmonicParams(71, 0.000000, 2.259121));
  Square.add(new HarmonicParams(-71, 0.034505, -2.356194));
  Square.add(new HarmonicParams(72, 0.000000, -0.628520));
  Square.add(new HarmonicParams(-72, 0.000000, 2.813016));
  Square.add(new HarmonicParams(73, 0.032662, -2.356194));
  Square.add(new HarmonicParams(-73, 0.000000, 0.736141));
  Square.add(new HarmonicParams(74, 0.000000, 0.907198));
  Square.add(new HarmonicParams(-74, 0.000000, -2.959170));
  Square.add(new HarmonicParams(75, 0.000000, 0.737333));
  Square.add(new HarmonicParams(-75, 0.030964, -2.356194));
  Square.add(new HarmonicParams(76, 0.000000, -2.269019));
  Square.add(new HarmonicParams(-76, 0.000000, 2.551182));
  Square.add(new HarmonicParams(77, 0.029397, -2.356194));
  Square.add(new HarmonicParams(-77, 0.000000, 1.371243));
  Square.add(new HarmonicParams(78, 0.000000, 0.365047));
  Square.add(new HarmonicParams(-78, 0.000000, -1.336497));
  Square.add(new HarmonicParams(79, 0.000000, -2.998022));
  Square.add(new HarmonicParams(-79, 0.027948, -2.356194));
  Square.add(new HarmonicParams(80, 0.000000, -1.008173));
  Square.add(new HarmonicParams(-80, 0.000000, 0.616083));
  Square.add(new HarmonicParams(81, 0.026604, -2.356194));
  Square.add(new HarmonicParams(-81, 0.000000, -2.236401));
  Square.add(new HarmonicParams(82, 0.000000, -2.848076));
  Square.add(new HarmonicParams(-82, 0.000000, 2.370441));
  Square.add(new HarmonicParams(83, 0.000000, -0.880783));
  Square.add(new HarmonicParams(-83, 0.025356, -2.356194));
  Square.add(new HarmonicParams(84, 0.000000, 1.465226));
  Square.add(new HarmonicParams(-84, 0.000000, 1.160310));
  Square.add(new HarmonicParams(85, 0.024196, -2.356194));
  Square.add(new HarmonicParams(-85, 0.000000, 0.401088));
  Square.add(new HarmonicParams(86, 0.000000, -2.848017));
  Square.add(new HarmonicParams(-86, 0.000000, -1.513366));
  Square.add(new HarmonicParams(87, 0.000000, 1.210487));
  Square.add(new HarmonicParams(-87, 0.023114, -2.356194));
  Square.add(new HarmonicParams(88, 0.000000, 3.135378));
  Square.add(new HarmonicParams(-88, 0.000000, 3.130362));
  Square.add(new HarmonicParams(89, 0.022105, -2.356194));
  Square.add(new HarmonicParams(-89, 0.000000, -0.914464));
  Square.add(new HarmonicParams(90, 0.000000, 0.135158));
  Square.add(new HarmonicParams(-90, 0.000000, -3.041556));
  Square.add(new HarmonicParams(91, 0.000000, -0.932647));
  Square.add(new HarmonicParams(-91, 0.021161, -2.356194));
  Square.add(new HarmonicParams(92, 0.000000, 2.694977));
  Square.add(new HarmonicParams(-92, 0.000000, 2.009617));
  Square.add(new HarmonicParams(93, 0.020278, -2.356194));
  Square.add(new HarmonicParams(-93, 0.000000, -1.725919));
  Square.add(new HarmonicParams(94, 0.000000, -1.159329));
  Square.add(new HarmonicParams(-94, 0.000000, 2.575175));
  Square.add(new HarmonicParams(95, 0.000000, 2.303911));
  Square.add(new HarmonicParams(-95, 0.019450, -2.356194));
  Square.add(new HarmonicParams(96, 0.000000, 0.573792));
  Square.add(new HarmonicParams(-96, 0.000000, 2.249929));
  Square.add(new HarmonicParams(97, 0.018673, -2.356194));
  Square.add(new HarmonicParams(-97, 0.000000, 0.143109));
  Square.add(new HarmonicParams(98, 0.000000, -1.413511));
  Square.add(new HarmonicParams(-98, 0.000000, 2.840193));
  Square.add(new HarmonicParams(99, 0.000000, 1.757887));
  Square.add(new HarmonicParams(-99, 0.017942, -2.356194));
  Square.add(new HarmonicParams(100, 0.000000, 0.035418));
  Square.add(new HarmonicParams(-100, 0.000000, 1.956223));
  Square.add(new HarmonicParams(101, 0.017254, -2.356194));
  Square.add(new HarmonicParams(-101, 0.000000, 0.634344));
  Square.add(new HarmonicParams(102, 0.000000, -1.162421));
  Square.add(new HarmonicParams(-102, 0.000000, -1.912753));
  Square.add(new HarmonicParams(103, 0.000000, 1.512473));
  Square.add(new HarmonicParams(-103, 0.016606, -2.356194));
  Square.add(new HarmonicParams(104, 0.000000, -1.768935));
  Square.add(new HarmonicParams(-104, 0.000000, 0.918333));
  Square.add(new HarmonicParams(105, 0.015995, -2.356194));
  Square.add(new HarmonicParams(-105, 0.000000, -3.003270));
  Square.add(new HarmonicParams(106, 0.000000, 2.877274));
  Square.add(new HarmonicParams(-106, 0.000000, 0.799219));
  Square.add(new HarmonicParams(107, 0.000000, 0.892976));
  Square.add(new HarmonicParams(-107, 0.015418, -2.356194));
  Square.add(new HarmonicParams(108, 0.000000, -1.618715));
  Square.add(new HarmonicParams(-108, 0.000000, 2.215105));
  Square.add(new HarmonicParams(109, 0.014872, -2.356194));
  Square.add(new HarmonicParams(-109, 0.000000, -1.792699));
  Square.add(new HarmonicParams(110, 0.000000, 2.851944));
  Square.add(new HarmonicParams(-110, 0.000000, 0.388081));
  Square.add(new HarmonicParams(111, 0.000000, -1.437354));
  Square.add(new HarmonicParams(-111, 0.014355, -2.356194));
  Square.add(new HarmonicParams(112, 0.000000, 1.748152));
  Square.add(new HarmonicParams(-112, 0.000000, -1.662943));
  Square.add(new HarmonicParams(113, 0.013866, -2.356194));
  Square.add(new HarmonicParams(-113, 0.000000, -1.291615));
  Square.add(new HarmonicParams(114, 0.000000, 1.577865));
  Square.add(new HarmonicParams(-114, 0.000000, -2.505192));
  Square.add(new HarmonicParams(115, 0.000000, 2.525907));
  Square.add(new HarmonicParams(-115, 0.013402, -2.356194));
  Square.add(new HarmonicParams(116, 0.000000, 1.554329));
  Square.add(new HarmonicParams(-116, 0.000000, 1.989197));
  Square.add(new HarmonicParams(117, 0.012961, -2.356194));
  Square.add(new HarmonicParams(-117, 0.000000, -0.279741));
  Square.add(new HarmonicParams(118, 0.000000, 1.949942));
  Square.add(new HarmonicParams(-118, 0.000000, -1.434851));
  Square.add(new HarmonicParams(119, 0.000000, -2.885167));
  Square.add(new HarmonicParams(-119, 0.012543, -2.356194));
  Square.add(new HarmonicParams(120, 0.000000, -2.086365));
  Square.add(new HarmonicParams(-120, 0.000000, 2.986592));
  Square.add(new HarmonicParams(121, 0.012145, -2.356194));
  Square.add(new HarmonicParams(-121, 0.000000, -2.385924));
  Square.add(new HarmonicParams(122, 0.000000, -3.017581));
  Square.add(new HarmonicParams(-122, 0.000000, 0.874938));
  Square.add(new HarmonicParams(123, 0.000000, 1.649499));
  Square.add(new HarmonicParams(-123, 0.011767, -2.356194));
  Square.add(new HarmonicParams(124, 0.000000, 0.063609));
  Square.add(new HarmonicParams(-124, 0.000000, 0.676730));
  Square.add(new HarmonicParams(125, 0.011406, -2.356194));
  Square.add(new HarmonicParams(-125, 0.000000, 0.044745));
  Square.add(new HarmonicParams(126, 0.000000, 1.706464));
  Square.add(new HarmonicParams(-126, 0.000000, 2.731565));
  Square.add(new HarmonicParams(127, 0.000000, -1.588022));
  Square.add(new HarmonicParams(-127, 0.011062, -2.356194));
  Square.add(new HarmonicParams(128, 0.000000, -0.231078));
  Square.add(new HarmonicParams(-128, 0.000000, -1.961384));
  Square.add(new HarmonicParams(129, 0.010735, -2.356194));
  Square.add(new HarmonicParams(-129, 0.000000, 2.308943));
  Square.add(new HarmonicParams(130, 0.000000, -1.768304));
  Square.add(new HarmonicParams(-130, 0.000000, -1.654474));
  Square.add(new HarmonicParams(131, 0.000000, 0.356566));
  Square.add(new HarmonicParams(-131, 0.010422, -2.356194));
  Square.add(new HarmonicParams(132, 0.000000, 0.869909));
  Square.add(new HarmonicParams(-132, 0.000000, -0.663411));
  Square.add(new HarmonicParams(133, 0.010123, -2.356194));
  Square.add(new HarmonicParams(-133, 0.000000, 2.003259));
  Square.add(new HarmonicParams(134, 0.000000, -0.770992));
  Square.add(new HarmonicParams(-134, 0.000000, 2.520254));
  Square.add(new HarmonicParams(135, 0.000000, 0.263712));
  Square.add(new HarmonicParams(-135, 0.009838, -2.356194));
  Square.add(new HarmonicParams(136, 0.000000, 2.692343));
  Square.add(new HarmonicParams(-136, 0.000000, -3.052423));
  Square.add(new HarmonicParams(137, 0.009564, -2.356194));
  Square.add(new HarmonicParams(-137, 0.000000, 2.085760));
  Square.add(new HarmonicParams(138, 0.000000, -0.666405));
  Square.add(new HarmonicParams(-138, 0.000000, -0.355367));
  Square.add(new HarmonicParams(139, 0.000000, 1.491573));
  Square.add(new HarmonicParams(-139, 0.009303, -2.356194));
  Square.add(new HarmonicParams(140, 0.000000, -2.534321));
  Square.add(new HarmonicParams(-140, 0.000000, 1.751490));
  Square.add(new HarmonicParams(141, 0.009053, -2.356194));
  Square.add(new HarmonicParams(-141, 0.000000, -1.590703));
  Square.add(new HarmonicParams(142, 0.000000, 1.945558));
  Square.add(new HarmonicParams(-142, 0.000000, -3.076852));
  Square.add(new HarmonicParams(143, 0.000000, -1.646437));
  Square.add(new HarmonicParams(-143, 0.008813, -2.356194));
  Square.add(new HarmonicParams(144, 0.000000, 0.150346));
  Square.add(new HarmonicParams(-144, 0.000000, 1.711188));
  Square.add(new HarmonicParams(145, 0.008583, -2.356194));
  Square.add(new HarmonicParams(-145, 0.000000, -1.581993));
  Square.add(new HarmonicParams(146, 0.000000, -2.938037));
  Square.add(new HarmonicParams(-146, 0.000000, 0.829491));
  Square.add(new HarmonicParams(147, 0.000000, 0.205162));
  Square.add(new HarmonicParams(-147, 0.008362, -2.356194));
  Square.add(new HarmonicParams(148, 0.000000, 0.829336));
  Square.add(new HarmonicParams(-148, 0.000000, -1.824241));
  Square.add(new HarmonicParams(149, 0.008150, -2.356194));
  Square.add(new HarmonicParams(-149, 0.000000, 0.313255));
  Square.add(new HarmonicParams(150, 0.000000, -1.575410));
  Square.add(new HarmonicParams(-150, 0.000000, 0.472209));
  Square.add(new HarmonicParams(151, 0.000000, -0.158153));
  Square.add(new HarmonicParams(-151, 0.007947, -2.356194));
  Square.add(new HarmonicParams(152, 0.000000, -3.005347));
  Square.add(new HarmonicParams(-152, 0.000000, 2.510390));
  Square.add(new HarmonicParams(153, 0.007751, -2.356194));
  Square.add(new HarmonicParams(-153, 0.000000, -0.455714));
  Square.add(new HarmonicParams(154, 0.000000, -2.762288));
  Square.add(new HarmonicParams(-154, 0.000000, -2.531998));
  Square.add(new HarmonicParams(155, 0.000000, -2.187221));
  Square.add(new HarmonicParams(-155, 0.007563, -2.356194));
  Square.add(new HarmonicParams(156, 0.000000, 0.961148));
  Square.add(new HarmonicParams(-156, 0.000000, 2.641613));
  Square.add(new HarmonicParams(157, 0.007382, -2.356194));
  Square.add(new HarmonicParams(-157, 0.000000, 0.969771));
  Square.add(new HarmonicParams(158, 0.000000, -1.681730));
  Square.add(new HarmonicParams(-158, 0.000000, -1.517584));
  Square.add(new HarmonicParams(159, 0.000000, 1.563015));
  Square.add(new HarmonicParams(-159, 0.007208, -2.356194));
  Square.add(new HarmonicParams(160, 0.000000, -1.054242));
  Square.add(new HarmonicParams(-160, 0.000000, -2.486389));
  Square.add(new HarmonicParams(161, 0.007041, -2.356194));
  Square.add(new HarmonicParams(-161, 0.000000, -2.685360));
  Square.add(new HarmonicParams(162, 0.000000, -0.603759));
  Square.add(new HarmonicParams(-162, 0.000000, 3.113380));
  Square.add(new HarmonicParams(163, 0.000000, -0.586038));
  Square.add(new HarmonicParams(-163, 0.006879, -2.356194));
  Square.add(new HarmonicParams(164, 0.000000, 0.306427));
  Square.add(new HarmonicParams(-164, 0.000000, -1.683940));
  Square.add(new HarmonicParams(165, 0.006724, -2.356194));
  Square.add(new HarmonicParams(-165, 0.000000, 2.533645));
  Square.add(new HarmonicParams(166, 0.000000, -2.350411));
  Square.add(new HarmonicParams(-166, 0.000000, 0.014869));
  Square.add(new HarmonicParams(167, 0.000000, 1.111520));
  Square.add(new HarmonicParams(-167, 0.006574, -2.356194));
  Square.add(new HarmonicParams(168, 0.000000, 3.016647));
  Square.add(new HarmonicParams(-168, 0.000000, 2.177836));
  Square.add(new HarmonicParams(169, 0.006429, -2.356194));
  Square.add(new HarmonicParams(-169, 0.000000, -0.252434));
  Square.add(new HarmonicParams(170, 0.000000, 1.543671));
  Square.add(new HarmonicParams(-170, 0.000000, 2.325177));
  Square.add(new HarmonicParams(171, 0.000000, -0.496823));
  Square.add(new HarmonicParams(-171, 0.006289, -2.356194));
  Square.add(new HarmonicParams(172, 0.000000, -0.932868));
  Square.add(new HarmonicParams(-172, 0.000000, -2.653798));
  Square.add(new HarmonicParams(173, 0.006155, -2.356194));
  Square.add(new HarmonicParams(-173, 0.000000, 2.345883));
  Square.add(new HarmonicParams(174, 0.000000, -0.883948));
  Square.add(new HarmonicParams(-174, 0.000000, -0.355082));
  Square.add(new HarmonicParams(175, 0.000000, -1.477032));
  Square.add(new HarmonicParams(-175, 0.006025, -2.356194));
  Square.add(new HarmonicParams(176, 0.000000, -2.085495));
  Square.add(new HarmonicParams(-176, 0.000000, 0.976618));
  Square.add(new HarmonicParams(177, 0.005899, -2.356194));
  Square.add(new HarmonicParams(-177, 0.000000, -2.127900));
  Square.add(new HarmonicParams(178, 0.000000, 2.798245));
  Square.add(new HarmonicParams(-178, 0.000000, 1.476336));
  Square.add(new HarmonicParams(179, 0.000000, -0.498457));
  Square.add(new HarmonicParams(-179, 0.005777, -2.356194));
  Square.add(new HarmonicParams(180, 0.000000, -2.156556));
  Square.add(new HarmonicParams(-180, 0.000000, -3.063951));
  Square.add(new HarmonicParams(181, 0.005660, -2.356194));
  Square.add(new HarmonicParams(-181, 0.000000, -1.639921));
  Square.add(new HarmonicParams(182, 0.000000, -2.237232));
  Square.add(new HarmonicParams(-182, 0.000000, 3.138711));
  Square.add(new HarmonicParams(183, 0.000000, -0.733239));
  Square.add(new HarmonicParams(-183, 0.005546, -2.356194));
  Square.add(new HarmonicParams(184, 0.000000, 1.927143));
  Square.add(new HarmonicParams(-184, 0.000000, 1.906054));
  Square.add(new HarmonicParams(185, 0.005436, -2.356194));
  Square.add(new HarmonicParams(-185, 0.000000, 0.702156));
  Square.add(new HarmonicParams(186, 0.000000, 1.973049));
  Square.add(new HarmonicParams(-186, 0.000000, 2.581917));
  Square.add(new HarmonicParams(187, 0.000000, -2.358459));
  Square.add(new HarmonicParams(-187, 0.005330, -2.356194));
  Square.add(new HarmonicParams(188, 0.000000, -0.392645));
  Square.add(new HarmonicParams(-188, 0.000000, 1.575819));
  Square.add(new HarmonicParams(189, 0.005226, -2.356194));
  Square.add(new HarmonicParams(-189, 0.000000, -0.996398));
  Square.add(new HarmonicParams(190, 0.000000, 2.090406));
  Square.add(new HarmonicParams(-190, 0.000000, -0.444135));
  Square.add(new HarmonicParams(191, 0.000000, -0.208125));
  Square.add(new HarmonicParams(-191, 0.005127, -2.356194));
  Square.add(new HarmonicParams(192, 0.000000, -1.888300));
  Square.add(new HarmonicParams(-192, 0.000000, 0.901071));
  Square.add(new HarmonicParams(193, 0.005030, -2.356194));
  Square.add(new HarmonicParams(-193, 0.000000, 2.154881));
  Square.add(new HarmonicParams(194, 0.000000, 1.806545));
  Square.add(new HarmonicParams(-194, 0.000000, -0.956176));
  Square.add(new HarmonicParams(195, 0.000000, -2.327525));
  Square.add(new HarmonicParams(-195, 0.004936, -2.356194));
  Square.add(new HarmonicParams(196, 0.000000, -1.998634));
  Square.add(new HarmonicParams(-196, 0.000000, -0.299859));
  Square.add(new HarmonicParams(197, 0.004845, -2.356194));
  Square.add(new HarmonicParams(-197, 0.000000, 2.105421));
  Square.add(new HarmonicParams(198, 0.000000, 0.134275));
  Square.add(new HarmonicParams(-198, 0.000000, -0.062796));
  Square.add(new HarmonicParams(199, 0.000000, -3.097384));
  Square.add(new HarmonicParams(-199, 0.004757, -2.356194));
}
